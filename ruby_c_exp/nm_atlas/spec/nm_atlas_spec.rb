...
describe NMatrix::CLAPACK_ATLAS do 
  [:float32, :float64, :complex64].each do |dtype|
    it "solves the equation" do
      ...
      expect(NMatrix::CLAPACK_ATLAS.solve_gesv(a,b)).to eq(
        NMatrix.new([3,1], 
          [-0.661082, 
            9.456125, 
        ...
        x.report do
          10000.times do
            ...
            b = NMatrix.new([3,1], [10,
                                     7,
                                    43], dtype: :float64)
            NMatrix::CLAPACK_ATLAS.solve_gesv(a,b)
          end
        end
      end
    end
